...
const TABS: Array<{
    ...
    order: number;
}> = [
        {
            ...
            description: 'Импорт офисов. Гео-координаты будут определены автоматически по адресу.',
            order: 1,
            columns: 'Офис, Адрес',
            example:
                'Офис,Адрес\nАстана,Достык 16 БЦ Talan\nАлматы,пр-т Аль-Фараби 77/7',
        ...
        },
        {
            ...
            example:
                'ФИО,Должность,Офис,Навыки,Количество обращений в работе\nСергей Власов,Ведущий специалист,Алматы,"VIP,ENG,KZ",3\nЕлена Ким,Главный специалист,Астана,"VIP,KZ",0\nАлексей Тен,Специалист,Астана,"KZ,ENG",2',
        ...
        },
        {
            ...
            order: 3,
            columns: 'GUID клиента, Пол клиента, Дата рождения, Описание, Вложения, Сегмент клиента, Страна, Область, Населённый пункт, Улица, Дом',
            example:
                'GUID клиента,Пол клиента,Дата рождения,Описание,Вложения,Сегмент клиента,Страна,Область,Населённый пункт,Улица,Дом\nfe44694a-10ed-f011-8406-0022481ba5f0,Мужской,1998-10-02,"Мне нужно изменить данные.",pasport.jpg,VIP,Казахстан,город Астана,Есильский район,улица Достык,16',
