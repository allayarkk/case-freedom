                    ...
                    <table className="w-full text-left border-collapse min-w-[1000px]">
                        <thead className="sticky top-0 bg-[#0d161d] z-20 shadow-[0_1px_0_0_rgba(35,54,66,1)]">
                            <tr className="text-[10px] text-[#5b6f7c] uppercase font-extrabold tracking-widest">
                                ...
                                <th className="px-6 py-4 border-b border-[#233642] text-right"></th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-[#233642]/50">
                            {filteredTickets.map((ticket, idx) => (
                                <motion.tr
                                    ...
                                    className="group hover:bg-[#182833]/30 transition-colors cursor-pointer"
                                >
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <ChevronRight size={18} className="text-[#233642] group-hover:text-[#3489db] transition-colors" />
                                    </td>
                                </motion.tr>
                            ))}
                        </tbody>
