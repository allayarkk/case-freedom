...
ВАЖНО ПРО ЗНАЧЕНИЯ ПОЛЕЙ: 
- "gender" в БД записан как 'Мужской' или 'Женский' (с большой буквы!), а не 'М'/'Ж'. Если фильтруешь по полу - используй полные слова.
- "segment" бывает 'VIP', 'PRIORITY', 'MASS'. Используй ИМЕННО эти значения для фильтров.
