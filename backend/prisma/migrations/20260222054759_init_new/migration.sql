-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('Жалоба', 'Смена_данных', 'Консультация', 'Претензия', 'Неработоспособность_приложения', 'Мошеннические_действия', 'Спам', 'НЕ_РАЗОБРАНО');

-- CreateEnum
CREATE TYPE "Sentiment" AS ENUM ('Позитивный', 'Нейтральный', 'Негативный');
...
-- CreateEnum
CREATE TYPE "ManagerPosition" AS ENUM ('Специалист', 'Ведущий_специалист', 'Главный_специалист');
...
CREATE TABLE "TicketAnalysis" (
    ...
    "latitude" DOUBLE PRECISION,
    "longitude" DOUBLE PRECISION,
    "aiDuration" INTEGER DEFAULT 0,
    "geoDuration" INTEGER DEFAULT 0,
    "routingDuration" INTEGER DEFAULT 0,
